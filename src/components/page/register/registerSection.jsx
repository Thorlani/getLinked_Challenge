      ...
      <div className="w-full h-full relative p-[8%] overflow-clip">
        ...
        <div className="w-full h-full absolute top-0 left-0 z-10">
          <img
            src={Sata}
            alt="Star"
            className="absolute w-4 lg:w-[20px] object-contain left-[14%] top-[22%] hidden lg:block"
          />
          <img
            src={Star1}
            alt="Star"
          ...
          <img
            src={Star3}
            alt="Star"
            className="absolute w-5 lg:w-[25px] object-contain left-[82%] top-[17%] hidden lg:block"
          />
          <img
            src={Sata}
            alt="Star"
            className="absolute w-5 lg:w-[25px] object-contain left-[82%] top-[17%] block lg:hidden"
          />
          <img
            src={Sata}
            alt="Star"
